...
class AbstractModel (metaclass=ABCMeta):
    ...
    def __init__(self):
        ...
        self._machine.add_transition(trigger='ready', source=['loading_data', 'building_model', 'training', 'updating_properties', 'miniaturizing', 'predicting', 'saving_model', 'saving_predictions', 'resetting', 'saving_ptmodel'], dest='ready')
